...
# brps_seasonal.R - summary statistics for each scenario
# wkdlssls2019/fun/brps_seasonal.R
...
brpsson <- function( stk, B0, R0, rec.ss=1, ssb.ss=1, sr_model, sr_params, 
                           Fprop = rep(0.5, dim(stk)[4]), Fscan=seq(0,4,by=0.01), 
...
#------------------------------------------------------------------------------#
# brpsson_plot (obj) :: YPR plot from brpsson output  
#------------------------------------------------------------------------------#


brpsson_plot <- function( obj, pdfflnm="Fbar_vs_SPR.pdf") {
